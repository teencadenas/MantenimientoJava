...
public class GestionServiciosSolicitados {
    ...
    public List<Servicio> listar(String idServiciosSolicitados) throws SQLException {
    ...
    public int nuevo(List<Servicio> listado, int idServiciosSolicitados) throws SQLException {
...
//            Se devuelve la respuesta
    ...
    public int actualizar(List<Servicio> listado, String idServiciosSolicitados) throws SQLException {
